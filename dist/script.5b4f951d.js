...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"exercice_1.5/script.ts":[function(require,module,exports) {
// Exercice 1
// Lorsque l'utilisateur clique sur le bouton vous ajoutez la class "green" au carré
//  const button: HTMLElement | null = document.getElementById("myButton1");
//  const square:  HTMLElement | null = document.getElementById("mySquare1");
...
//  const button: HTMLElement | null = document.getElementById("myButton2");
//  const square:  HTMLElement | null = document.getElementById("mySquare2");
//  button?.addEventListener("click", () => {
...
//  const input = document.getElementById("myInput3") as HTMLInputElement;
//  const text = document.getElementById("myText3");
//  button?.addEventListener("click", () => {
//    const reponse = input.value;
//    if (reponse === "4") {
//      text.textContent = "Bonne";
//    } else {
//      text.textContent = "Mauvaise";
//    }
//  });
// Exercice 4
...
var equipeA = ['Martin', 'Lucie', 'Jasmine'];
var equipeB = ['Lisa', 'Mathieu', 'Anthony'];
var equipeC = ['Anissa', 'Laïla', 'Jean-Paul'];
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","exercice_1.5/script.ts"], null)
//# sourceMappingURL=/script.5b4f951d.js.map