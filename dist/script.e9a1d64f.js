...
var domExoTwo = document.getElementsByClassName;
// Exercice 3
...
var domExoThree = document.getElementById('exoThree');
if (domExoThree !== null) {
  domExoThree.addEventListener('click', userClick);
}
...
var buttonPlus = document.getElementById('incrementButton');
var buttonMoins = document.getElementById('decrementButton');
var count = 0;
...
if (buttonPlus && buttonMoins) {
  buttonPlus.addEventListener('click', incrementCount);
  buttonMoins.addEventListener('click', decrementCount);
}
// Exercice 5.1
...
var domExoFive = document.getElementById('inputTextExo5');
var exoCinquUn = document.getElementById('replaceMe');
if (domExoFive !== null) {
  domExoFive.addEventListener('input', handleInputChanges);
}
function handleInputChanges(event) {
  var _a;
  if (exoCinquUn !== null) {
    exoCinquUn.innerText = (_a = event.target) === null || _a === void 0 ? void 0 : _a.value;
  }
}
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","exercice_1/script.ts"], null)
//# sourceMappingURL=/script.e9a1d64f.js.map